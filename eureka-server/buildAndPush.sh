...
docker tag eureka-server:latest 129822709161.dkr.ecr.eu-west-1.amazonaws.com/eureka-server:latest
docker push 129822709161.dkr.ecr.eu-west-1.amazonaws.com/eureka-server:latest
