...
docker tag category-service:latest 129822709161.dkr.ecr.eu-west-1.amazonaws.com/category-service:latest
docker push 129822709161.dkr.ecr.eu-west-1.amazonaws.com/category-service:latest
